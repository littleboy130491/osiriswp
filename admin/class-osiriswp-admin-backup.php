...
class OsirisWP_Admin_Backup {
	...
	public function handle_csv_export() {
		...
		$events = $this->get_all_events_for_export( $visitor_uuid, $page, $event_name, $date_from, $date_to, $cookie_name );
	...
	private function get_all_events_for_export( $visitor_uuid = '', $page = '', $event_name = '', $date_from = '', $date_to = '', $cookie_name = '' ) {
		global $wpdb;
